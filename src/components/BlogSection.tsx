      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            <h2 className="text-[46px] font-bold uppercase tracking-[0.15em] text-brand-primary/60 mb-4 overflow-visible whitespace-normal w-full max-w-full break-normal">Blog Ambiental</h2>
