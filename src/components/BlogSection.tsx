      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4 lg:sticky lg:top-32">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-brand-forest opacity-50 mb-4">Blog Ambiental</h2>
            <h3 className="font-serif text-4xl md:text-5xl font-bold text-brand-primary italic leading-[1.1] mb-8">
              Artículos & Noticias Verdes
            </h3>
            <p className="text-brand-forest/70 mb-10 text-lg">
            ...
            <a 
              ...
              className="inline-block bg-brand-sky text-white px-8 py-4 rounded-full font-bold hover:bg-brand-sky/90 transition-all text-center shadow-lg shadow-brand-sky/20"
            >
          ...
          <div className="lg:col-span-8 flex flex-col gap-12">
            {content.blog.map((post, index) => (
              ...
              >
                ...
                <div className="absolute top-0 right-0 p-8 font-serif text-9xl font-bold text-brand-secondary/10 italic pointer-events-none group-hover:scale-110 transition-transform duration-1000">
                  {index + 1}
                </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-6 text-[10px] font-bold uppercase tracking-widest text-brand-forest/60 mb-6 font-sans">
                    <span className="flex items-center gap-2">
                       <Calendar className="w-3 h-3 text-brand-secondary" /> {post.date}
                    </span>
                  ...
                  <h4 className="font-serif text-2xl md:text-3xl font-bold text-brand-primary mb-6 group-hover:translate-x-2 transition-transform duration-500">
                    {post.title}
                  </h4>
                  ...
                  <button 
                    ...
                    className="flex items-center gap-2 text-brand-secondary font-bold text-sm uppercase tracking-widest group-hover:gap-4 transition-all hover:text-brand-primary"
                  >
