...
export default function Logo({ className = "w-10 h-10" }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M 200 220 Q 250 205 300 220" stroke="#1f2937" strokeWidth="2" opacity="0.2" fill="none" />
      <path d="M 215 210 Q 250 200 285 210" stroke="#1f2937" strokeWidth="1" opacity="0.1" fill="none" />

      {/* Side Dots */}
      <circle cx="95" cy="255" r="6" fill="#1f2937" />
      <circle cx="405" cy="255" r="6" fill="#1f2937" />
